  ...
  if (contactForm) {
    ...
    function getFormFields() {
      return Array.from(contactForm.querySelectorAll(
        'input:not([type="submit"]):not([type="button"]):not([type="reset"]):not([type="hidden"]):not([type="checkbox"]):not([type="radio"]), textarea, select'
      ));
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5405b3c3-1eac-4d41-bb6d-a1b0790832ee',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5405b3c3-1eac-4d41-bb6d-a1b0790832ee';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5405b3c3-1eac-4d41-bb6d-a1b0790832ee';
